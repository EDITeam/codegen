package com.avatech.dahupt.${projectName}.starter.v1;

import com.avatech.dahupt.${projectName}.model.bo.${domainModel.modelName?lower_case}.${domainModel.modelName};
import com.avatech.dahupt.${projectName}.starter.${projectName?cap_first}Application;
...
@SpringBootTest(classes = ${projectName?cap_first}Application.class)
